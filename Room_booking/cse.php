...
<div class="row jumbotron">
      <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
	    <p class="lead">By using this link, you can see the Class schedule of CSE buiding</p>
		</div>
		  ...
		  <div class="modal-dialog text-content" id="myModal">
		    <div class="col-12 main-section">
			 ...
			 <div class="modal-header">
			   ...
			   <form class="col-12" action="visitorscse.php" method="POST">
		  ...
		  <div class="modal-dialog text-content" id="myModal">
		    <div class="col-12 main-section">
			 ...
			 <div class="modal-header">
			   ...
			   <form class="col-12" action="admincse.php" method="POST">
			    <div class="form-group">
