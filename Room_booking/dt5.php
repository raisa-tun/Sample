	 ...
	 <div class="collapse navbar-collapse" id="navbarResponsive">
	    <ul class="navbar-nav ml-auto">
		   ...
		   <a class="nav-link" href="cse.php">CSE Building</a>
		    ...
		    <li class="nav-item">
		   <a class="nav-link" href="mainbuild.php">Main Building</a>
		   </li>
...
<div class="row jumbotron">
      <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
	    <p class="lead">By using this link, you can see the Class schedule of Daffodil Tower</p>
		</div>
		  ...
		  <div class="modal-dialog text-content" id="myModal">
		    <div class="col-12 main-section">
			 ...
			 <div class="modal-header">
			   ...
			   <form class="col-12" action="visitorsdt5.php" method="POST">
		  ...
		  <div class="modal-dialog text-content" id="myModal">
		    <div class="col-12 main-section">
			 ...
			 <div class="modal-header">
			   ...
			   <form class="col-12" action="admindt5.php" method="POST">
			    <div class="form-group">
